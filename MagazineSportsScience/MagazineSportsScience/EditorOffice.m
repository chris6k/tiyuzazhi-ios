...
#import "EditorOffice.h"

@implementation EditorOffice
...
- (IBAction)DoFilterProcess:(id)sender {
    ...
    if([self IsLogining])
    {
        ...
        if(![self IsLoading])
        {
            [self  performSegueWithIdentifier:@"segueFilterProcess" sender:self];
        }
    }
...
- (IBAction)unwindEditorOfficViewController:(UIStoryboardSegue *)segue
{
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self  performSegueWithIdentifier:@"segueEditorDetail" sender:tableView];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"segueEditorDetail"])
    {
    ...
    if ([segue.identifier isEqualToString:@"segueFilterProcess"]) {
        [segue.destinationViewController setValue:@"U" forKey:@"role"];
    }
}
